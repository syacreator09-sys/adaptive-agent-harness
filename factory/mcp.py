...
class MCPDiscovery:
    ...
    AAH does not invent or install third-party MCP servers. It discovers servers
    already configured by the project/user, exposes only safe metadata to the
    router, and lets tasks request a server explicitly with `mcp:<name>`.
    """
    ...
    def inspect(self) -> dict[str, Any]:
        ...
        codex = codex_project + [item for item in codex_user if item["name"] not in {x["name"] for x in codex_project}]
