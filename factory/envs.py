...
SECRET_NAME = re.compile(
    r"(KEY|TOKEN|SECRET|PASSWORD|PASSWD|PRIVATE|CREDENTIAL|COOKIE|SESSION|AUTH|JWT|DATABASE_URL|DB_URL|REDIS_URL|MONGODB_URI|DSN|CONNECTION_STRING)",
    re.I,
)
...
class EnvRouter:
    ...
    REVIEW_ROLES = {
        ...
        "content_strategist","content_evaluator","researcher","fact_checker",
        "security_reviewer","final_reviewer",
    }
